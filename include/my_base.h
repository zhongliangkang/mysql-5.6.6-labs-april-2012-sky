...
/** PERSISTENT_STATS=1 has been specified in the SQL command (either CREATE
...
#define HA_OPTION_PERSISTENT_STATS	4096
/** PERSISTENT_STATS=0 has been specified in CREATE/ALTER TABLE. Statistics
for the table will be wiped away on server shutdown and new ones recalculated
after the server is started again. If none of HA_OPTION_PERSISTENT_STATS or
HA_OPTION_NO_PERSISTENT_STATS is set, this means that the setting is not
explicitly set at table level and the corresponding table will use whatever
is the global server default. */
#define HA_OPTION_NO_PERSISTENT_STATS	8192
