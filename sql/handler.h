...
/** This is set whenever PERSISTENT_STATS=0|1|'default' has been
specified in CREATE/ALTER TABLE. See also HA_OPTION_PERSISTENT_STATS in
include/my_base.h. It is possible to distinguish whether
PERSISTENT_STATS='default' has been specified or no PERSISTENT_STATS= is
given at all. */
#define HA_CREATE_USED_PERSISTENT_STATS (1L << 22)
