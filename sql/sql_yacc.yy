        ...
        | DECLARE_SYM ident CURSOR_SYM FOR_SYM sp_cursor_stmt
          {
            ...
            i= new sp_instr_cpush(sp->instructions(), pctx, $5,
...
simple_when_clause:
          ...
          expr
          {
            ...
            if (case_stmt_action_when(thd, $3, true))
              MYSQL_YYABORT;
...
searched_when_clause:
          ...
          expr
          {
            ...
            if (case_stmt_action_when(thd, $3, false))
              MYSQL_YYABORT;
...
sp_unlabeled_control:
        ...
        | WHILE_SYM 
          ...
          expr DO_SYM
          {
            ...
            sp_instr_jump_if_not *i=
              new sp_instr_jump_if_not(sp->instructions(), pctx, $3, lex);
        ...
        | REPEAT_SYM sp_proc_stmts1 UNTIL_SYM 
          ...
          expr END REPEAT_SYM
          {
            ...
            sp_instr_jump_if_not *i=
              new sp_instr_jump_if_not(ip, pctx, $5,
...
create_table_option:
        ...
        | PERSISTENT_STATS_SYM opt_equal ulong_num
          {
            switch($3) {
            case 0:
        ...
        | PERSISTENT_STATS_SYM opt_equal DEFAULT
          {
            Lex->create_info.table_options&=
