...
extern	ib_counter_t<ib_int64_t, IB_N_SLOTS>	rw_s_spin_wait_count;
/** number of spin loop rounds on rw-latches,
resulted during exclusive (write) locks */
extern	ib_counter_t<ib_int64_t, IB_N_SLOTS>	rw_s_spin_round_count;
/** number of unlocks (that unlock shared locks),
set only when UNIV_SYNC_PERF_STAT is defined */
extern	ib_counter_t<ib_int64_t, IB_N_SLOTS>	rw_s_exit_count;
/** number of OS waits on rw-latches,
resulted during shared (read) locks */
extern	ib_counter_t<ib_int64_t, IB_N_SLOTS>	rw_s_os_wait_count;
/** number of spin waits on rw-latches,
resulted during shared (read) locks */
extern	ib_counter_t<ib_int64_t, IB_N_SLOTS>	rw_x_spin_wait_count;
/** number of spin loop rounds on rw-latches,
resulted during shared (read) locks */
extern	ib_counter_t<ib_int64_t, IB_N_SLOTS>	rw_x_spin_round_count;
/** number of OS waits on rw-latches,
resulted during exclusive (write) locks */
extern	ib_counter_t<ib_int64_t, IB_N_SLOTS>	rw_x_os_wait_count;
/** number of unlocks (that unlock exclusive locks),
set only when UNIV_SYNC_PERF_STAT is defined */
extern	ib_counter_t<ib_int64_t, IB_N_SLOTS>	rw_x_exit_count;
