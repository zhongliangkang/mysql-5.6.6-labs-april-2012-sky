				...
				user OS thread */
{
	...
	if (thr->lock_state == QUE_THR_LOCK_ROW) {
		srv_counter.n_lock_wait_count.inc();
		srv_counter.n_lock_wait_current_count.inc();
	...
	if (thr->lock_state == QUE_THR_LOCK_ROW) {
		...
		srv_counter.n_lock_wait_current_count.dec();
		srv_counter.n_lock_wait_time.inc(diff_time);
