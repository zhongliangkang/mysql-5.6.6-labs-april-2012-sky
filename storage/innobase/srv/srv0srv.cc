...
UNIV_INTERN ulong	srv_max_io_capacity     = 4000;
...
UNIV_INTERN srv_counter_t	srv_counter;
...
UNIV_INTERN ulonglong	srv_stats_transient_sample_pages = 8;
UNIV_INTERN my_bool	srv_stats_persistent = FALSE;
UNIV_INTERN ulonglong	srv_stats_persistent_sample_pages = 20;
...
UNIV_INTERN ulong	srv_spin_wait_delay	= 12;
...
/*==================================*/
{
	...
	srv_n_rows_inserted_old = srv_counter.n_rows_inserted;
	srv_n_rows_updated_old = srv_counter.n_rows_updated;
	srv_n_rows_deleted_old = srv_counter.n_rows_deleted;
	srv_n_rows_read_old = srv_counter.n_rows_read;
				...
				the list of active transactions */
{
	...
	fprintf(file,
		...
		", read " ULINTPF "\n",
		(ulint) srv_counter.n_rows_inserted,
		(ulint) srv_counter.n_rows_updated,
		(ulint) srv_counter.n_rows_deleted,
		(ulint) srv_counter.n_rows_read);
	fprintf(file,
		"%.2f inserts/s, %.2f updates/s,"
		" %.2f deletes/s, %.2f reads/s\n",
		((ulint) srv_counter.n_rows_inserted - srv_n_rows_inserted_old)
		/ time_elapsed,
		((ulint) srv_counter.n_rows_updated - srv_n_rows_updated_old)
		/ time_elapsed,
		((ulint) srv_counter.n_rows_deleted - srv_n_rows_deleted_old)
		/ time_elapsed,
		((ulint) srv_counter.n_rows_read - srv_n_rows_read_old)
		/ time_elapsed);
...
/*==========================*/
{
	...
	export_vars.innodb_data_read = srv_counter.data_read;

	export_vars.innodb_data_reads = os_n_file_reads;

	export_vars.innodb_data_writes = os_n_file_writes;

	export_vars.innodb_data_written = srv_counter.data_written;

	export_vars.innodb_buffer_pool_read_requests = stat.n_page_gets;

	export_vars.innodb_buffer_pool_write_requests =
		srv_counter.buf_pool_write_requests;

	export_vars.innodb_buffer_pool_wait_free =
		srv_counter.buf_pool_wait_free;

	export_vars.innodb_buffer_pool_pages_flushed =
		srv_counter.buf_pool_flushed;

	export_vars.innodb_buffer_pool_reads = srv_counter.buf_pool_reads;
	...
	export_vars.innodb_log_waits = srv_counter.log_waits;

	export_vars.innodb_os_log_written = srv_counter.os_log_written;
	...
	export_vars.innodb_os_log_pending_writes =
		srv_counter.os_log_pending_writes;

	export_vars.innodb_log_write_requests = srv_counter.log_write_requests;

	export_vars.innodb_log_writes = srv_counter.log_writes;

	export_vars.innodb_dblwr_pages_written =
		srv_counter.dblwr_pages_written;

	export_vars.innodb_dblwr_writes = srv_counter.dblwr_writes;
	...
	export_vars.innodb_row_lock_waits = srv_counter.n_lock_wait_count;

	export_vars.innodb_row_lock_current_waits =
		srv_counter.n_lock_wait_current_count;

	export_vars.innodb_row_lock_time = srv_counter.n_lock_wait_time / 1000;

	if (srv_counter.n_lock_wait_count > 0) {

		export_vars.innodb_row_lock_time_avg = (ulint)
			(srv_counter.n_lock_wait_time
			 / 1000 / srv_counter.n_lock_wait_count);
	...
	export_vars.innodb_rows_read = srv_counter.n_rows_read;

	export_vars.innodb_rows_inserted = srv_counter.n_rows_inserted;

	export_vars.innodb_rows_updated = srv_counter.n_rows_updated;

	export_vars.innodb_rows_deleted = srv_counter.n_rows_deleted;
