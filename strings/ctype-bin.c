...
/* Used by MY_SORT_LEN_GT_0(), @see include/m_ctype.h */
#define MY_SORT_ORDER(K)	(K)
                           ...
                           ulong *nr1, ulong *nr2)
{
  ...
  */
  size_t l = skip_trailing_space(key, len) - key;

  if (l > 0)
  {
    MY_SORT_LEN_GT_0(key, l, nr1, nr2);
  }
}
		      ...
		      const uchar *key, size_t len,ulong *nr1, ulong *nr2)
{
  if (len > 0)
  {
    MY_SORT_LEN_GT_0(key, len, nr1, nr2);
  }
}
